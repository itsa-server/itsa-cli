...
const model = (options, language) => {
    // this === request
    const pageheaderPromise = fsMD.readFile('../markdowns/'+language+'/production-header.MD');
    const pagecontentPromise = fsMD.readFile('../markdowns/'+language+'/production-content.MD');
