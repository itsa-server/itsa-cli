...
const model = (options, language) => {
    // this === request
    const pageheaderPromise = fsMD.readFile('../markdowns/'+language+'/environments-header.MD');
    const pagecontentPromise = fsMD.readFile('../markdowns/'+language+'/environments-content.MD');
