...
const model = (options, language) => {
    // this === request
    const pageheaderPromise = fsMD.readFile('../markdowns/'+language+'/appfile-header.MD');
    const pagecontentPromise = fsMD.readFile('../markdowns/'+language+'/appfile-content.MD');
