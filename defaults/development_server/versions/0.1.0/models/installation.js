...
const model = (options, language) => {
    // this === request
    const pageheaderPromise = fsMD.readFile('../markdowns/'+language+'/installation-header.MD');
    const pagecontentPromise = fsMD.readFile('../markdowns/'+language+'/installation-content.MD');
