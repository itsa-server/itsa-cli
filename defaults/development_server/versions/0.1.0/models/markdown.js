...
const model = (options, language) => {
    // this === request
    const pageheaderPromise = fsMD.readFile('../markdowns/'+language+'/markdown-header.MD');
    const pagecontentPromise = fsMD.readFile('../markdowns/'+language+'/markdown-content.MD');
