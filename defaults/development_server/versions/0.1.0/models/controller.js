...
const model = (options, language) => {
    // this === request
    const pageheaderPromise = fsMD.readFile('../markdowns/'+language+'/controller-header.MD');
    const pagecontentPromise = fsMD.readFile('../markdowns/'+language+'/controller-content.MD');
