...
const model = (options, language) => {
    // this === request
    const pageheaderPromise = fsMD.readFile('../markdowns/'+language+'/developing-header.MD');
    const pagecontentPromise = fsMD.readFile('../markdowns/'+language+'/developing-content.MD');
